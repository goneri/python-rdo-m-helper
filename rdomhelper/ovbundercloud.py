...
class OVBUndercloud(Undercloud):
    def __init__(self, nova_api=None, neutron=None, provisioner=None, key_filename=None, ip=None, flavor='m1.small', **kwargs):
        ...
        Undercloud.__init__(self, hostname=undercloud_ip, key_filename=key_filename, **kwargs)
